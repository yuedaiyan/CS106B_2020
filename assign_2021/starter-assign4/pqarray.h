...
public:
     ...
     *
     * This operation runs in time O(N),
     ...
     *
     * The frontmost element is the one with the most urgent priority.
     * A priority of 1 is more urgent than priority 2 which is more
     * urgent than priority 7 and so on.
     *
     * If the priority queue contains two or more elements of equal
     * priority, the order those elements are dequeued is arbitrary,
     * i.e. there is no required tie-break handling.
     *
    ...
    /* This function exists purely for testing purposes.
     * You can have it do whatever you'd like.
     * We will not invoke it when grading.
     *
     * The provided implementation prints out the contents of
     * the array for easy viewing purposes.
     */
    void printDebugInfo(std::string msg) const;

    /* This function exits purely for testing purposes.
     *
     * It verifies that the internal state of the queue is valid/consistent.
     *
